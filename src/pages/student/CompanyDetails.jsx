...
<div className="lg:w-2/3 relative bg-white/60 border border-violet-200/50 p-6 rounded-2xl shadow-xl flex flex-col items-center min-h-[450px] overflow-hidden">
  <AnimatePresence>
    {selectedExperience ? (
      <motion.div
        ...
        className="absolute top-0 left-0 w-full h-full flex items-center justify-center backdrop-blur-xl z-10 p-4"
      ...
      >
        {/* Content Card */}
        <div className="relative flex flex-col items-center p-6 rounded-2xl bg-[#1b1433] border border-violet-500/40 shadow-2xl w-full max-w-2xl mx-auto">
  {/* Close Button */}
  <button
    onClick={() => setSelectedExperience(null)}
    className="absolute top-4 right-4 text-violet-500 text-2xl font-bold hover:text-violet-700 transition"
  >
    ✕
  </button>
  ...
  <div className="relative mb-6 flex justify-center">
    <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-violet-500 to-pink-500 opacity-70 blur-lg"></div>
    <img
      src={selectedExperience.profilePic || "/images/profile.png"}
      alt={selectedExperience.title}
      className="relative h-24 w-24 rounded-full border-4 border-[#1b1433] object-cover shadow-xl"
    />
  </div>

  {/* Name */}
  <h2 className="text-center text-2xl font-bold text-white mb-2 after:content-[''] after:block after:w-24 after:h-1 after:rounded-full after:bg-gradient-to-r after:from-violet-500 after:to-pink-500 after:mt-2 after:mx-auto">
    {selectedExperience.title}
  </h2>

  {/* Details */}
  <p className="text-center text-sm sm:text-base leading-relaxed text-white mt-4 px-4">
    {selectedExperience.details}
      ...
      <>
        ...
        <div className="mt-8 flex justify-center">
          <button
            onClick={() => navigate("/student/home")}
            className="px-6 py-2 bg-gradient-to-r from-violet-500 to-indigo-600 text-white rounded-full shadow-md hover:scale-105 transition"
          >
            Back to Dashboard
          </button>
        </div>
