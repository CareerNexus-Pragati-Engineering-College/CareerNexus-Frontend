...
import { FaChevronLeft, FaChevronRight, FaTerminal, FaPaperPlane, FaAward } from "react-icons/fa";
...
const StudentCodingExam = () => {
    ...
    useEffect(() => {
        const fetchExam = async () => {
            try {
                ...
                toast.error("Failed to load exam. It might have ended.");
    ...
    if (loading) return (
        <div className="h-screen bg-[#0f0c1d] flex flex-col items-center justify-center text-white">
            ...
            <p className="text-xl font-medium">Entering secure exam environment...</p>
        </div>
    );
        ...
        <div className="h-screen bg-[#0f0c1d] flex flex-col overflow-hidden font-poppins">
            ...
            <header className="h-16 bg-[#16112a] border-b border-gray-800 px-6 flex items-center justify-between z-50">
                ...
                <div className="flex items-center gap-4">
                    ...
                    >
                        {isSubmitting ? "Submitting..." : <><FaPaperPlane /> Submit Assessment</>}
                    </button>
                </div>
            </header>
                    ...
                    >
                        ...
                        */}
                        <CodeEditor
                            ...
                            initialLanguage={answers[currentQuestion.id]?.language || "javascript"}
