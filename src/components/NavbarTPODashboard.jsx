// src/components/NavbarTPODashboard.jsx
    ...
    <nav className="w-full fixed top-0 left-0 z-50 bg-gradient-to-r from-[#0f0c1d] via-[#1b1433] to-[#0f0c1d] shadow-md font-outfit">
      <div className="max-w-auto px-6 py-4 flex items-center justify-between">
        ...
        <NavLink to={`/tpo/${userId}/home`} className="flex items-center gap-3">
          ...
          />
          <span className="text-white text-2xl font-semibold tracking-wider drop-shadow-[0_0_8px_rgba(165,100,255,0.6)] font-outfit">
            CareerNexus
          </span>
        </NavLink>
        ...
        <div className="hidden md:flex items-center space-x-6 text-white text-base">
          ...
          {/* Dynamic Links for Dashboard Sections */}
          <NavLink
            ...
            {showDropdown && (
              <div className="absolute right-0 mt-2 w-40 bg-[#1b1433] border border-violet-500/30 rounded-lg shadow-xl p-2 z-50">
                <NavLink
                  ...
                  className="flex items-center px-3 py-2 text-white hover:text-violet-400 transition rounded-md font-outfit text-sm"
                ...
                <button
                  ...
                  className="flex items-center w-full px-3 py-2 text-red-500 hover:text-red-400 transition rounded-md mt-1 font-outfit text-sm"
                >
      ...
      {isOpen && (
        <div className="md:hidden bg-[#0f0c1d] px-6 pb-6 space-y-4 text-white text-base">
          ...
          <button
            className="flex items-center gap-2 text-red-500 mt-2 hover:text-red-400 transition font-outfit"
            onClick={() => {
              setIsOpen(false);
              handleLogout();
            }}
...
export default NavbarTPODashboard;
