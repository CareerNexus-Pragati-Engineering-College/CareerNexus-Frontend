    ...
    <nav className="w-full fixed top-0 left-0 z-50 bg-gradient-to-r from-[#0f0c1d] via-[#1b1433] to-[#0f0c1d] shadow-md">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-6 text-white text-base font-poppins">
          ...
          {/* ✨ Login / Signup Buttons with Glow */}
          <NavLink
            to="/student/login"
          ...
          <NavLink
            to="/student/signup"
            className="ml-2 px-4 py-2 rounded-md bg-gradient-to-r from-violet-500 to-indigo-600 text-white font-semibold shadow-[0_0_12px_rgba(165,100,255,0.6)] hover:shadow-[0_0_20px_rgba(165,100,255,0.8)] transition-all duration-300"
          >
            Signup
          </NavLink>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-[#0f0c1d] px-6 pb-6 space-y-4 text-white text-base font-poppins">
          ...
          <div className="pt-2 flex flex-col gap-2">
            ...
            <NavLink
              to="/student/signup"
              className="px-4 py-2 rounded-md bg-gradient-to-r from-violet-500 to-indigo-600 text-white font-semibold shadow-[0_0_14px_rgba(165,100,255,0.6)] transition-all duration-300"
              onClick={() => setIsOpen(false)}
            >
              Signup
            </NavLink>
